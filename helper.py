...
class Helper:
    ...
    def update_elo_rating(self, elo, other_player_rating, state):
        base = 5
        if state == 'Win':
            if other_player_rating == elo:
                elo += base

            elif other_player_rating > elo:
                if other_player_rating > elo + 100:
                    elo += base + 10

                elif other_player_rating > elo + 75:
                    elo += base + 8   

                elif other_player_rating > elo + 50:
                    elo += base + 6   
                    
                elif other_player_rating > elo + 20:
                    elo += base + 4      
                
                elif other_player_rating > elo + 10:
                    elo += base + 2      
            ...
            if other_player_rating > elo:
                ...
                if other_player_rating + 100 < elo:
                    elo -= base - 2
                
                elif other_player_rating + 75 < elo:
                    elo -= base - 3
                
                elif other_player_rating + 50 < elo:
                    elo -= base - 4
            
        return elo

    def add_game(self, color, state, as_white, as_black) -> list[tuple, tuple]:
        if state == 'Win':
            if color == 'W':
                as_white[0] += 1
            else:
